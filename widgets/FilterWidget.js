define([
    ...
    'dojo/aspect'
], function (dcl, domClass, TemplatedWidgetBase, aspect) {
    return dcl(TemplatedWidgetBase, {
        declaredClass: "xlog.widgets.FilterWidget",
        wButton: null,
        wThumb: null,
        wList: null,
        wTree: null,
        ...
        menuItems: null,
        templateString: "<div><div class='' data-dojo-type='dijit.form.DropDownButton' data-dojo-props=\"iconClass:'fa-sliders'\" data-dojo-attach-point='wButton'>" +
        "<span></span>" +
        ...
        _createDefaultItems: function () {
            this.menuItems = [];
            this.firstItem = null;
            var actions = this.delegate.getFilters(this.item) || this._defaultItems();
